    ...
    <div className="space-y-5">
      <section className="ac-card p-4">
        ...
        <div className="mt-3 flex flex-wrap gap-x-6 gap-y-2 text-sm text-ink-2">
          ...
          <span>
            <span className="font-semibold tabular-nums text-ink">{deliverables}</span> 项成果
          </span>
          <span>
        ...
        <p className="mt-3 text-xs leading-5 text-ink-3">
          上面的数字全部由系统在每次变更时自动登记，<span className="text-ink-2">没有任何一格需要成员填写</span>。
        </p>
      </section>
      ...
      <section className="ac-card overflow-hidden">
        ...
        <div className="flex flex-wrap gap-3 border-t border-stroke px-4 py-3 text-xs">
          <Link href={`/projects/${projectId}/retrospective`} className="text-signal hover:underline">
            项目复盘与贡献记录 →
          </Link>
        </div>
      </section>
